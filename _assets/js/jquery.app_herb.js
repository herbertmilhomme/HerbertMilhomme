...
! function($) {
    ...
    */
    var SideBar = function() {
        ...
        this.$headerBar = $('header#header-top'),
    ...
    SideBar.prototype.init = function() {
        ...
        $(document).on('click', '.navbar-toggle', function () {
            ...
            $this.$headerBar.toggleClass('collapsed2');
        }); 
            ...
            if ($this.$sideBar.hasClass('collapsed') == false || $(window).width() < 768) {
                ...
                if (!$(this).next().is(":visible")) {
                    $(this).next().slideToggle(300, function () {
                        ...
                        $("header#header-top:not(.collapsed2)").getNiceScroll().resize();
                    });
...
function($) {
    ...
    var VelonicApp = function() {
        this.VERSION = "0.0.0",//"1.0.0", 
        this.AUTHOR = "Herb.",//"Coderthemes", 
        this.SUPPORT = "herb@herbertmilhomme.com",//"coderthemes@gmail.com", 
